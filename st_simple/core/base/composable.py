...
from .models.composable import ComponentParserValidator, LayerIDValidator

T = TypeVar('T', bound='Composable')  # Type variable for method chaining



class Composable:
    """
    Base class for Composable components that can organize content in layers.
    Each layer can contain one or more components, and the layout can be customized
    ...
    def __init__(self):
        """Initialize a new Composable instance with an empty schema."""
        self.schema = Schema()
    ...
    def set_component_parser(self, component_parser: Callable[..., Any]) -> T:
        """
        Sets the component parser for the Composable object.
    ...
    def __render_column_based(
        self, based_component: Callable[..., Any], *args: Any, **kwargs: Any
    ) -> Any:
        """
    ...
    def lrender(self, based_component: Callable[..., Any], *args: Any, **kwargs: Any) -> Any:
        """
    ...
    def add_component(self, component: Callable[..., Any], *args: Any, **kwargs: Any) -> Any:
        """
    ...
    def clear(self) -> "Composable":
        ...
        Returns:
            Composable: Returns the instance of the object to allow for method chaining.
        """
        self.schema = Schema()
        return self
    ...
    @classmethod
    def deserialize(cls, data: Dict[str, Any], content_map: Optional[Dict[str, Any]] = None) -> 'Composable':
        """
        Creates a Composable instance from serialized data.

        Args:
            data (Dict[str, Any]): The serialized data.
            
        Returns:
            Composable: A new Composable instance.
        """
        instance = cls()
        instance._column_based = data.get("column_based", False)
        
        if "schema" in data:
            instance.schema = Schema.deserialize(data["schema"], content_map or {})
